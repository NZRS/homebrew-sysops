class JenkinsJobBuilderinz < Formula
  ...
  head "https://github.com/openstack-infra/jenkins-job-builder.git", :branch => "master"

  bottle do
    cellar :any
    sha256 "30d3b92dce78c395cb72781a30aad38d715d7ff5ba436434139ec2cc26e7c087" => :catalina
  end
